...
class BasicAuthPage(BasePage):
    ...
    def __init__(self, browser: Browser):
        ...
        self.unique_element = WebElement(self.browser, self.UNIQUE_ELEMENT_LOC,
                                         description='Basic Auth page title -> Open Page')
        self.success_text_element = WebElement(self.browser, self.SUCCESS_TEXT_LOC,
                                               description='Success message text -> Get Text')
